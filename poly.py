...
# Training set
x_train = [[6], [8], [10], [14], [18]] #volume of water
y_train = [[7], [9], [13], [17.5], [18]] #prices of waters

# Testing set
x_test = [[6], [8], [11], [16]] #volume of water
y_test = [[8], [12], [15], [18]] #prices of waters
...
plt.title('Water price regressed on volume')
plt.xlabel('Volume in litres')
